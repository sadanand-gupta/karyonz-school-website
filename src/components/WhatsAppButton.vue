<script setup>
const phoneDigits = '919566593549'
...
<template>
  <a
    ...
    class="fixed bottom-5 right-5 z-40 grid place-items-center w-14 h-14 rounded-full bg-[#25D366] shadow-lg shadow-black/20 hover:scale-105 transition-transform"
  >
