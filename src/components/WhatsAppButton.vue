...
<template>
  <a
    ...
    class="fixed bottom-5 right-5 z-40 grid place-items-center w-14 h-14 rounded-full bg-[#25D366] shadow-lg shadow-black/25 hover:scale-105 transition-transform"
  >
